...
<div class="machineRefBox"><img alt="Vista aislada de la máquina asociada al patrón {title.lower()}" src="../../../artifacts/ejercicios-compartido/images/{repo}-machine-only.png" loading="lazy"/><span class="refTag">VISTA AISLADA · ILUSTRACIÓN DE APOYO</span></div>
<div class="muscleRefBox"><div class="muscleInfo"><span class="primary"><span class="muscleTag">ENFOQUE</span> {str(item["focus"])}</span><span class="secondary"><span class="muscleTag">PROCEDENCIA</span> Recurso local verificado {repo}; la vista aislada editada es apoyo visual y la identidad de la máquina del gimnasio requiere confirmación directa.</span></div></div>
</div>
<div class="photoTitleRow"><b>POSICIÓN Y RECORRIDO</b></div>
<div class="phaseRow">
<div class="phaseCol"><div class="phaseLabel">Inicio · imagen estática</div><div class="photo techniqueVisual"><img class="realphoto day3StaticFrame" src="../../../artifacts/ejercicios-compartido/images/{static_start}" alt="{title} · posición inicial estática" loading="lazy"/><div class="brokenFallback">Imagen estática inicial no disponible.</div></div><div class="source">Inicio · posición de partida · sin rebotes</div></div>
<div class="swap" aria-hidden="true">→</div>
<div class="phaseCol"><div class="phaseLabel">Final · imagen estática</div><div class="photo techniqueVisual"><img class="realphoto day3StaticFrame" src="../../../artifacts/ejercicios-compartido/images/{static_final}" alt="{title} · posición final estática" loading="lazy"/><div class="brokenFallback">Imagen estática final no disponible.</div></div><div class="source">Final · contracción controlada · regreso lento</div></div>
</div>
<div class="gifProof"><div class="gifProofTitle">GIF · RECORRIDO COMPLETO</div><div class="photo techniqueVisual gifPreview"><img class="realphoto day3ExerciseGif" src="../../../artifacts/ejercicios-compartido/videos/{repo}.gif" data-static-src="../../../artifacts/ejercicios-compartido/images/{static_start}" alt="{title} · GIF local del recorrido completo" loading="lazy"/><div class="brokenFallback">GIF no disponible; se conserva la referencia estática.</div></div><div class="videoProof"><span>GIF local · {repo} · licencia/procedencia de redistribución pendiente</span></div></div>
</div>

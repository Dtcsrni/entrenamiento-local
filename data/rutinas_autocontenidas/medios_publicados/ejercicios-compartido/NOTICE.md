...
- **Attribution:** every use must carry the copyright indication
  **© Gym visual — https://gymvisual.com/**. Each record in
  [`data/exercises.json`](https://github.com/hasaneyldrm/exercises-dataset/blob/7455efae41b330c265e7cd4b78dfa848e7ce5ebd/data/exercises.json) also carries an `attribution`

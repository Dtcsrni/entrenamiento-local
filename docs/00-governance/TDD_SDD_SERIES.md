...
| [TDD-005](../05-quality/TDD-005-pwa-perfil-e2e.md) | **Builders, publicación, requisitos PWA/perfil y E2E.** | Salida reproducible; inventario/drift; FUN-PWA-001..006, FUN-PRO-001..011, NFR aplicables; cuatro rutinas y cache/update. | A + V + H | In progress |
